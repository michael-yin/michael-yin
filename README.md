...
* [django-vite-boilerplate](https://github.com/AccordBox/django-vite-boilerplate): The fastest way to use Vite with Django. Get HMR, Tailwind, and HTMX in seconds with zero manual configuration. 
